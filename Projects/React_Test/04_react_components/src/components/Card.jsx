...
const Card = (props) => {
    return (
        <div className="mr-5 mb-3 bg-white text-black inline-block p-6 text-center rounded">
            ...
            <button className="mt-5 bg-emerald-600 text-white px-4 py-2 rounded font-medium hover:bg-emerald-700 hover:scale-105 active:bg-emerald-900 active:scale-100 transition duration-200" onClick={() => alert('Friend added!')}>Add Friend</button>
        </div>
    )
}
